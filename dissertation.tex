...
\newcommand{\limbpath}   {/Dropbox/" io"/dissertation/figures/geometry/graphics/}
...
%  %  %   %  %  %   %  %  %   %  %  %   Chapters   %  %  %   %  %  %   %  %  %   %  %  %
\input{chapters/"ch 01"/head_introduction}
\input{chapters/"ch apparatus"/"head apparatus"}
\input{chapters/"ch theory"/"head theory"}
\input{chapters/"ch rte"/"head rte"}
\input{chapters/"ch continuum"/"head continuum"}
\input{chapters/"ch measurement"/"head measurement"}
\input{chapters/"ch simulation"/"head simulation"}
\input{chapters/"ch future"/"head future"}
%\input{chapters/introduction/head_introduction}
...
\addcontentsline{toc}{chapter}{Appendices}
 ...
 % "Appendix Table of Contents," if desired:
   \contentsline {chapter}{\numberline {A}Electronic structure of atoms}{25}
   \contentsline {chapter}{\numberline {B}Approximation by polynomials}{27}
   \contentsline {chapter}{\numberline {C}Fortran codes}{27}
   \contentsline {chapter}{\numberline {D}Mathematica code}{60}
 % End mini table of contents

\appendix
%\include{appendices/scattering}
\input{appendices/"app electronic structure of atoms"/"head electronic structure"}
